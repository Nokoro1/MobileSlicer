...
6. Keep `scripts/verify_android.sh orca-step-sliced-source-fixture` green so MobileSlicer-produced STEP packages continue to preserve part-level `.step`/`.stp` `source_file` evidence.
