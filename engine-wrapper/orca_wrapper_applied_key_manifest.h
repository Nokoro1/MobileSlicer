#ifndef ORCA_WRAPPER_APPLIED_KEY_MANIFEST_H
#define ORCA_WRAPPER_APPLIED_KEY_MANIFEST_H

// Native-owned audit manifest for Orca config keys explicitly applied as
// active MobileSlicer native slicing behavior by
// orca_wrapper_config_json_overrides.h. Preserved profile keys that are not
// explicitly mapped in the wrapper must stay out of this list.
//
// This file is generated mechanically from explicit wrapper set calls and
// filtered to real Orca config keys. Update it when adding or removing native
// config application points.
[[maybe_unused]] static constexpr const char* kMobileSlicerNativeAppliedOrcaKeys[] = {
...
#endif // ORCA_WRAPPER_APPLIED_KEY_MANIFEST_H
